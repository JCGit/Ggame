...
//	BOOL AddFile(LPCTSTR lpSourcePath, LPCTSTR lpTargetPath);
	...
	//  implemented
	HANDLE CreateFile(LPCTSTR lpFileName, ULONG ulReservedSize);
    ...
    /////////////////////////////////////////////////////////////////////////*/	
	BOOL GetFileSize(HANDLE hFile, LPDWORD lpFileSize);
    ...
    /////////////////////////////////////////////////////////////////////////*/	
	BOOL GetFilePointer(HANDLE hFile, LPDWORD lpFilePosition);
    ...
    /////////////////////////////////////////////////////////////////////////*/	
	BOOL FindFile(HANDLE hFile, LPCTSTR FileSpec, FileList& fileList, BOOL bRecursive = FALSE);
